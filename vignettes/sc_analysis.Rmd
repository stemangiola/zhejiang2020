...
```{r}
#--- loading ---#
R.utils::gunzip(system.file("extdata", "pbmc4k_raw_gene_bc_matrices.tar.gz", package = "zhejiang2020"))
utils::untar(system.file("extdata", "pbmc4k_raw_gene_bc_matrices.tar", package = "zhejiang2020"), exdir = ".")

library(DropletUtils)
fname <- file.path("raw_gene_bc_matrices/GRCh38")
